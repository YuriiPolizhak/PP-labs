...
class Task4 {
    ...
    public void start()
    {
        ...
        out.println("\nEven numbers: "); printNumbers(GetEven());
        out.println("\nSum of odd"); out.print(sum(GetOdd()));
        out.println("\nSum of even"); out.print(sum(GetEven()));
        out.println("\nInput length of Fibonacci array:");
        ...
        out.println("\nPercentages: "); printPercentages(length,Fibonacci(length,Mosts()));
    }
}
